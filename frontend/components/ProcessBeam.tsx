...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-16 items-center justify-center rounded-full border-2 bg-white p-2 overflow-hidden shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
export function DescriptionFlow() {
  ...
  return (
    <div
      className="relative flex h-[400px] md:h-[500px] w-full md:w-1/2 items-center justify-center overflow-hidden md:px-10"
      ref={containerRef}
    >
      <div className="flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between gap-10">
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div1Ref} className="border-custom-green-400">
            <Image
              src="/avatars/head-ufo.png"
              alt="logo"
              width={200}
              height={200}
            />
          </Circle>
          <Circle ref={div5Ref} className="border-green-500">
            <Image
        ...
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div2Ref} className="border-custom-yellow-400">
            <Image
              src="/avatars/head-shark.png"
              alt="logo"
              width={200}
              height={200}
              className="mt-2"
          ...
          <Circle ref={div4Ref} className="size-16 border-custom-green-400">
            <Image
          ...
          <Circle ref={div6Ref} className="border-blue-400">
            <Image
              src="/avatars/unicef.png"
              alt="logo"
              width={250}
              height={200}
              className="mt-2"
        ...
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div3Ref} className="border-pink-500">
            <Image
              src="/avatars/head-flamingo.png"
              alt="logo"
              width={200}
              height={200}
              className="mt-2"
          ...
          <Circle ref={div7Ref} className="border-green-600">
            <Image
              src="/avatars/oxfam-2.png"
              alt="logo"
              width={200}
              height={200}
              className=""
