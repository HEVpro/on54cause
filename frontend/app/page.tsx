      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-center md:-translate-y-10 z-20 bg-white px-4 md:px-8">
        <div className="w-full md:w-1/2 h-auto flex flex-col items-start justify-between ">
          ...
          <p className="text-lg text-gray-800 mb-4">
            Is where passion meets purpose. Whether you're running a marathon,
            attending a concert, or participating in any event with a fee, this
            platform empowers you to fundraise for charities while achieving
            your personal goals.
          </p>
          <ul className="list-disc pl-5 text-base text-gray-700">
            ...
            <li className="mb-2">
              Reach your goal (e.g., 250 USDC), and the charity covers your fee.
              Any extra funds go straight to the cause!
            </li>
          </ul>
          <p className="mt-2 text-lg font-bold text-custom-green-400">
            Transparency is key: charities show exactly where the donations go.
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:items-end justify-between px-4 md:px-8">
        <div>
          ...
          <p className="text-lg text-gray-800 mb-4 max-w-xl">
            Built on blockchain for total transparency, you can trust every
            donation is accounted for, ensuring funds make the biggest impact
            possible.
          </p>
        </div>
